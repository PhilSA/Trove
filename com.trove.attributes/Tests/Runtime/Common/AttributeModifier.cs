...
namespace Trove.Attributes.Tests
{
    ...
    public struct AttributeModifier : IBufferElementData, IAttributeModifier<AttributeModifierStack, AttributeGetterSetter>
    {
        ...
        public uint _modifierID;
        public uint ModifierID
        {
            get { return this._modifierID; }
            set { this._modifierID = value; }
        }

        public int _affectedAttributeType;
        public int AffectedAttributeType
        {
            get { return this._affectedAttributeType; }
            set { this._affectedAttributeType = value; }
        }
