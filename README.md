...
| **Object Handles** | First, install: <br> `https://github.com/PhilSA/Trove.git?path=/com.trove.common` <br><br> Then, install: <br> `https://github.com/PhilSA/Trove.git?path=/com.trove.objecthandles` | Trove Object Handles provides a way of storing unmanaged handles to objects, used for fast lookups. <br> ([Documentation](./com.trove.objecthandles/README.md)) | ⚠️ |
